...
def start_real_time():
    ...
    yolo = YOLO(model_path=os.path.join(HOME_DIR,'snapshots/000/plate_model.h5'),
    ...
    createFolder('media/videos/result')


    createFolder('media/videos/result/frame')




    def detect_video_yolo(model, output_path=""):
    ...
    # croppedImage.show()
                ...
                plt.axis('off')
                plt.savefig('media/videos/result/frame/detected'+str_index2+'.jpg')
                index2 +=1
    ...
    return detect_video_yolo(yolo, '../../../data/output/test02.avi')
